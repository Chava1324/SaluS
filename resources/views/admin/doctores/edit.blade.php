            ...
            <div class="card shadow-lg border-0 rounded-3">
                ...
                <div class="card-header bg-info text-white d-flex justify-content-between align-items-center shadow-sm">
                    <h3 class="fw-bold text-uppercase fs-5 mb-0">
                        <i class="bi bi-pencil-square me-2"></i> Modificar Doctor: {{ $doctor->nombre }} {{ $doctor->apellido }}
                    </h3>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.doctores.update', $doctor->id) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ $doctor->nombre }}" id="nombres" name="nombres"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ $doctor->apellido }}" id="apellidos" name="apellidos"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" apellidosid="telefono" value="{{ $doctor->telefono }}" name="telefono"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" value="{{ $doctor->licencia_medica }}" id="licencia_medica"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="especialidad" value="{{ $doctor->especialidad }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" id="email" value="{{ $doctor->user->email }}" name="email"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" id="password_confirmation" name="password_confirmation"
                                        class="form-control bg-light" placeholder="Repite tu contraseña" >
                                </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="{{ url('admin/doctores') }}" class="btn btn-outline-secondary btn-lg">
