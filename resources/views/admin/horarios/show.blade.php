            ...
            <div class="card shadow-lg border-0 rounded-3">
                ...
                <div class="card-header bg-info text-white text-center py-3">
                    <h3 class="fw-bold text-uppercase mb-0">
                        <i class="bi bi-calendar-week me-2"></i> Detalles del Horario
                    </h3>
                </div>
                ...
                <div class="card-body bg-light p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control bg-light text-muted border-0 shadow-sm"
                                    value="{{ $horario->doctor->nombre }} {{ $horario->doctor->apellido }} - {{ $horario->doctor->especialidad }}"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control bg-light text-muted border-0 shadow-sm"
                                    value="{{ $horario->consultorio->nombre}} - {{ $horario->consultorio->ubicacion }}"
                                    readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control bg-light text-muted border-0 shadow-sm"
                                    value="{{ $horario->hora_fin }}" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-footer text-center bg-light mt-4">
                        <a href="{{ url('admin/horarios') }}" class="btn btn-outline-secondary shadow-sm">
