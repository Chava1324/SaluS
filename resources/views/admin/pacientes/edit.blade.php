        ...
        <div class="card shadow-lg border-0 rounded-3 overflow-hidden">
            <div class="card-header bg-warning text-white text-center py-3 px-4 shadow-sm">
                <h3 class="fw-bold text-uppercase mb-0 d-flex justify-content-center align-items-center">
                    ...
                    Modificación de Paciente: {{ $paciente->nombres }} {{ $paciente->apellidos }}
                </h3>
            </div>

            <div class="card-body p-4 bg-light">
                <form action="{{ url('/admin/pacientes/'.$paciente->id) }}" method="POST" class="space-y-4">
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        <!-- Nombre y Apellido -->
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="{{ $paciente->nombres }}" id="nombre" name="nombre"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="{{ $paciente->apellidos }}" id="apellidos" name="apellidos"
                                    class="form-control focus:ring focus:ring-blue-300"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="{{ $paciente->curp }}" id="curp" name="curp"
                                    class="form-control focus:ring focus:ring-blue-300" placeholder="Introduce la CURP"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="{{ $paciente->nss }}" id="nss" name="nss"
                                    class="form-control focus:ring focus:ring-blue-300" placeholder="Introduce el NSS"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" value="{{ $paciente->fecha_nacimiento }}" id="fecha_nacimiento"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-warning text-black">
                                    <i class="bi bi-gender-ambiguous text-black"></i>
                                </span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" value="{{ $paciente->telefono }}" id="telefono" name="telefono"
                                    class="form-control focus:ring focus:ring-blue-300"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="{{ $paciente->direccion }}" id="direccion" name="direccion"
                                    class="form-control focus:ring focus:ring-blue-300"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="{{ $paciente->alergias }}" id="alergias" name="alergias"
                                    class="form-control focus:ring focus:ring-blue-300"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" value="{{ $paciente->contacto_emergencia }}" id="contacto_emergencia"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <textarea id="observaciones" name="observaciones"
                                    class="form-control focus:ring focus:ring-blue-300"
                                    placeholder="Introduce observaciones">{{ value($paciente->observaciones) }}</textarea>
                            </div>
                            @error('observaciones')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
