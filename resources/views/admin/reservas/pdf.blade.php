    ...
    <table class="table table-borderless" style="width: 100%;">
        <tr>
            ...
            <td class="text-end align-top" style="width: 30%;">
                <img src="{{ public_path('storage/' . $configuracion->logo) }}" alt="Logo" width="100px" style="border-radius: 50%;">
            </td>
        </tr>
    </table>
    <h3 style="text-align: center" class="text-center text-dark mb-4">Listado del personal citas</h3>
    <hr>
